...
import CommercialJson from "@/assets/lottie/commercial.json";
import CommercialDarkJson from "@/assets/lottie/commercial-dark.json";
...
export const Commercial = () => {
  ...
  return (
    <div className="relative overflow-hidden !pb-[80px] md:!pb-[120px]">
      <Lottie className="absolute z-[-1] max-md:hidden left-0 top-[-4vh] aspect-[1440/600] w-full" animationData={isLight ? CommercialJson : CommercialDarkJson} loop={true} ></Lottie>
      <div className="container overflow-hidden text-center md:aspect-[1440/600]">
