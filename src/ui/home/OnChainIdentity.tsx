...
import AssetAnalysisIcon from "@/assets/svg/home/asset-analysis.svg"
import AssetsIcon from "@/assets/svg/home/assets.svg"
import IdIcon from "@/assets/svg/home/id.svg"
import MultiChainIcon from "@/assets/svg/home/multi-chain.svg"
import SdkIcon from "@/assets/svg/home/sdk.svg"
...
export const OnChainIdentity = () => {
    return <div className="flex py-[40px] max-md:flex-col md:py-[80px] gap-[140px] items-center w-full justify-between">
        <div className="flex-1">
            ...
            <img alt="" src={OnChainIdentityIcon} className="shrink-0 mb-6 md:hidden w-full h-auto"></img>
            {
                tips && tips.map((item, index) => {
                    return <div key={index} className="flex items-center gap-[14px] mb-4 md:mb-5">
                        <img alt="" src={item.icon} className="text-t8"></img>
        ...
        <img alt="" src={OnChainIdentityIcon} className="shrink-0 max-md:hidden w-[45%] h-auto"></img>
